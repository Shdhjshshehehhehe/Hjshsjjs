...
runcode(function()
	...
	local LightingAst = GuiLibrary.ObjectsThatCanBeSaved.RenderWindow.Api.CreateOptionsButton({
		Name = "Lighting",
		HoverText = "Makes The Game Smoother",
		Function = function(callback)
			...
			if Enabled then
				...
				spawn(function()
					...
					damagetab.baseColor = Color3.fromRGB(255, 0, 255)
					...
					sunray = Instance.new("SunRaysEffect")
					...
					--skyColor.TintColor = Color3.fromRGB(255,0,255)
					...
					windsnow = Instance.new("ParticleEmitter")
					windsnow.Acceleration = Vector3.new(0,0,1)
					windsnow.RotSpeed = NumberRange.new(100)
					--[[windsnow.VelocitySpread = 40
					windsnow.Rate = 30]]
